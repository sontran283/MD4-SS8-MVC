...
<form action="<%=request.getContextPath()%>/product" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="radio" id="Active" name="categoryStatus" value="true" ${product.categoryStatus ? "checked" : ""}>
        <label for="Active">Active</label>
        <input type="radio" id="IsActive" name="categoryStatus" value="false" ${!product.categoryStatus ? "checked" : ""} >
